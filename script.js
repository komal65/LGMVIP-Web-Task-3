...
function data(){
    ...
    if(element[5].value !="")
    {
     ...
     if(element[9].checked){skills.innerHTML="SKILLS: REACT JS";}
    ...
    if(element[6].checked && element[7].checked && element[8].checked&& element[9].checked){skills.innerHTML="SKILLS: HTML,CSS,JS,REACT JS";}
